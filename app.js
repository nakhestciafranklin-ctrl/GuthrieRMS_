...
if(app){app.innerHTML='<div style="font-family:Arial,sans-serif;padding:32px;text-align:center;color:#003DA5"><h1>Guthrie RMS</h1><p>Loading...</p></div>';}
...
let html5QrCodeLibraryPromise=null;
function ensureHtml5QrcodeLibrary(){
  if(typeof Html5Qrcode!=='undefined') return Promise.resolve(true);
  if(html5QrCodeLibraryPromise) return html5QrCodeLibraryPromise;
  html5QrCodeLibraryPromise=new Promise(resolve=>{
    ...
    setTimeout(()=>resolve(typeof Html5Qrcode!=='undefined'),8000);
  });
  return html5QrCodeLibraryPromise;
}
